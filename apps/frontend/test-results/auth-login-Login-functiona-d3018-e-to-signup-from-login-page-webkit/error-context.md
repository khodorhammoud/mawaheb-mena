...
- Location: C:\Users\Moussa\Desktop\WIX\mawaheb-mena\apps\frontend\e2e\auth\login.spec.ts:41:3
...
Call log:
  - waiting for getByText('Don\'t have an account? Sign up')
    ...
    at C:\Users\Moussa\Desktop\WIX\mawaheb-mena\apps\frontend\e2e\auth\login.spec.ts:45:61
```
