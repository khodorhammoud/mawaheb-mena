...
- Name: Employer Signup Flow >> should show validation errors for missing fields
- Location: C:\Users\user\Desktop\work\GIG Platform\code\mawaheb-mena\apps\frontend\e2e\auth\employer-signup.spec.ts:33:3
...
Locator: getByText(/Email Address is required/i).first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 260000ms
  - waiting for getByText(/Email Address is required/i).first()

    at C:\Users\user\Desktop\work\GIG Platform\code\mawaheb-mena\apps\frontend\e2e\auth\employer-signup.spec.ts:40:72
```
...
- textbox "Email Address Enter your email"
- text: Email Address
- textbox "First Name"
- text: First Name
- textbox "Last Name"
