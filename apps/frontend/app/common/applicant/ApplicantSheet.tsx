...
const ApplicantSheet: React.FC<ApplicantSheetProps> = ({ isOpen, onClose }) => {
  type ActionData = {
    error?: { message: string };
  };

  //   const { freelancers, accountBio, about } = useLoaderData<LoaderData>();
        ...
        <SheetHeader>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 mb-4">
              <div className="grid mb-4 grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-3 ml-10 mr-10">
                {/* Hourly Rate */}
              ...
              <div className="grid mb-4 grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 ml-10 mr-10">
                {/* Add Video */}
                <GeneralizableFormCard
                  formType="video"
            ...
            hope to accomplish."
              ...
              <div className="grid mb-4 grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-1 ml-10 mr-10">
                {/* Portfolio */}
                <GeneralizableFormCard
                  formType="repeatable"
                  cardTitle="Projects"
