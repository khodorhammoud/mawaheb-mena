...
export const action: ActionFunction = async ({ request }) => {
  ...
  const accountType = formData.get('accountType') as AccountType.Freelancer | AccountType.Employer;
  ...
  const authStrategy =
    accountType == AccountType.Employer ? 'google_employer' : 'google_freelancer';
