          ...
          <div className="absolute inset-0 flex justify-center items-center">
            <div className="max-w-md text-center p-4">
              ...
              <p className="text-lg text-gray-800 font-medium mb-2">
                Working with Mawaheb MENA has been a game-changer for our
                company. The platform provided us with access to a pool of
                highly skilled freelancers who delivered exceptional results on
                every job. From web development to graphic design, we found
                top-tier talent for all our needs.
              </p>
              <p className="text-sm text-gray-500">Ahmad Ramal</p>
              <p className="text-sm text-gray-400">CEO wayx</p>
            </div>
          </div>
        </div>
      </div>
