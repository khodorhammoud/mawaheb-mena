...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "preferredWorkingTimes" (
	"id" serial PRIMARY KEY NOT NULL,
	"accountId" integer,
	"day" "day_of_week",
	"startTime" time,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "preferredWorkingTimes" ADD CONSTRAINT "preferredWorkingTimes_accountId_accounts_id_fk" FOREIGN KEY ("accountId") REFERENCES "public"."accounts"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
