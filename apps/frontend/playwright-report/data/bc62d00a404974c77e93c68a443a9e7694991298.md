...
- Location: C:\Users\user\Desktop\work\GIG Platform\code\mawaheb-mena\apps\frontend\e2e\auth\employer-signup.spec.ts:33:5

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://localhost:5173/signup-employer
Call log:
  - navigating to "http://localhost:5173/signup-employer", waiting until "load"

    at C:\Users\user\Desktop\work\GIG Platform\code\mawaheb-mena\apps\frontend\e2e\auth\employer-signup.spec.ts:34:20
```
