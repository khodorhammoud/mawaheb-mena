...
- button "👤PersonalSet Up Your Dream Team"
- button "🏢CompanyHire Top Talent"
...
- button "Continue"
- text: or
- button "Continue with GoogleContinue with Google":
  - text: Continue with Google
  - img
  - text: Continue with Google
- link "Continue with LinkedInContinue with LinkedIn":
  - /url: /
  - text: Continue with LinkedIn
  - img
  - text: Continue with LinkedIn
- link "Continue with MicrosoftContinue with Microsoft":
  - /url: /
