...
console.log('process.env.POSTGRESQL_CONNECTION_STRING', process.env.POSTGRESQL_CONNECTION_STRING);
export default withAuth(
  config({
    db: {
      ...
      url: 'postgresql://postgres:pass@localhost:5432/mawaheb-cms?schema=public',
      enableLogging: true,
      idField: { kind: 'uuid' },
    },
    lists,
