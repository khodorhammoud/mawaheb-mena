                        ...
                        <div className="flex flex-col items-center w-full max-w-2xl mx-auto bg-white pl-2 pr-12 mt-20">
                            ...
                            {form.errors.email && (
                                <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4 w-full">
                                    <strong className="font-bold">Error! </strong><span>{form.errors.email}</span>
                                </div>
                            )}
                            <form onSubmit={submit} className="w-full space-y-6">
                                ...
                                <div>
                                    ...
                                    <input id="email" type="email" value={form.data.email} onChange={(e) => form.setData('email', e.target.value)}
                                        className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:border-[#27638a]" />
                                </div>
                                <div>
                                ...
                                <div className="text-right">
                                    <a href="/" className="text-sm font-medium text-[#27638a] underline hover:no-underline">Forgot Password?</a>
                                </div>
                                <button type="submit" disabled={form.processing}
                                    className="w-full py-3 text-lg font-semibold text-white bg-[#27638a] rounded-xl hover:opacity-90 transition">Continue</button>
                            </form>
                            <div className="relative flex items-center justify-center mt-6 mb-2 w-full">
                                <div className="flex-grow border border-gray-200 w-[270px] mt-1" />
                            ...
                            <div className="text-center mt-8">
                                <p className="text-sm text-gray-600">Don&apos;t have an account? <Link href="/signup-freelancer" className="text-[#27638a] font-medium hover:underline">SignUp</Link></p>
                            </div>
                        </div>
                    </div>
