        ...
        <PublicLayout>
            ...
            <div className="min-h-[70vh] flex items-center justify-center py-12 px-4">
                <div className="max-w-md w-full">
                    ...
                    <p className="text-gray-600 text-center mb-8">Start your freelancing journey</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <a href="/auth/google/freelancer" className="w-full flex items-center justify-center gap-2 border py-3 rounded-lg hover:bg-gray-50 transition">
                        ...
                        <p className="text-center text-sm text-gray-600 mt-4">
                            Already have an account? <Link href="/login-freelancer" className="text-indigo-600 hover:text-indigo-800 font-medium">Sign in</Link>
                        </p>
                        <p className="text-center text-sm text-gray-500">
                            <Link href="/signup-employer" className="hover:text-gray-700">Sign up as Employer</Link>
                        </p>
                    </form>
                </div>
            </div>
